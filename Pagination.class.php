...
class Pagination{
	...
	protected $firstLink   	= 'Primeiro';
	protected $nextLink		= 'Próximo &raquo;';
	protected $prevLink		= '&laquo; Anterior';
	protected $lastLink		= 'Último';
	protected $fullTagOpen	= '<div class="cd-pagination">';
	protected $fullTagClose	= '</div>';
	protected $firstTagOpen	= '';
	protected $firstTagClose= '&nbsp;';
	protected $lastTagOpen	= '&nbsp;';
	protected $lastTagClose	= '';
	protected $curTagOpen	= '&nbsp;<span class="atual">';
	protected $curTagClose	= '</span>';
	...
	function createLinks(){ 
		...
		if ($this->showCount){
		   ...
		   $info = '<span class="exibindo">Exibindo ' . $currentOffset . ' a ' ;
