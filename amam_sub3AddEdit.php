...
if(!empty($_GET['id'])){
  ...
  $userData = $db->getRows('amamentacao_sub3', $conditions);
}
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"><a href="amam_sub3Index.php" class="float-right"><i class="fad fa-backward"></i> Voltar</a></div>
        <div class="panel-body">
          <form method="post" action="amam_sub3Action.php" class="form">
