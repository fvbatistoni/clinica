...
if(!empty($_GET['id'])){
  ...
  $userData = $db->getRows('black_sub1', $conditions);
}
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"><a href="black_s1Index.php" class="float-right"><i class="fad fa-backward"></i> Voltar</a></div>
        <div class="panel-body">
          <form method="post" action="black_s1Action.php" class="form">
