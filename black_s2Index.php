...
$rowCount = $db->getRows('black_sub2', $con);

// Initialize pagination class
$pagConfig = array(
  'baseURL' => 'black_s2Index.php'.$searchStr,
  'totalRows' => $rowCount,
...
$black_sub2 = $db->getRows('black_sub2', $con);
      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12 search-panel">
          ...
          <span class="pull-right">
            <a href="black_ssAddEdit.php" class="btn btn-primary" role="button" aria-pressed="true"><i class="fad fa-plus"></i> Novo</a>
          </span>
        <hr>
        <!-- Data list table --> 
        <table class="table table-striped table-bordered" width="100%">
          ...
          <tbody>
            <?php
            if(!empty($black_sub2)){ $count = 0; 
              foreach($black_sub2 as $black_s2){ $count++;
            ?>
            <tr>
              <td><?php echo $black_s2['id']; ?></td>
              <td><?php echo $black_s2['nome']; ?></td>
              <td><?php echo $black_s2['sub1']; ?></td>
              <td><?php echo $black_s2['sub2']; ?></td>
              <td style="text-align: center;">
                <a href="black_s2AddEdit.php?id=<?php echo $black_s2['id']; ?>" class="fad fa-edit"></a>                
              </td>
              <td style="text-align: center;">
                <a href="black_s2Action.php?action_type=delete&id=<?php echo $black_s2['id']; ?>" class="fad fa-trash-alt" onclick="return confirm('Tem certeza que deseja apagar?')"></a>
              </td>
            </tr>
            <?php } }else{ ?>
