$(document).ready(function(){
  ...
  $.ajax({
    url: "ajax/get_pontualidade_ano_ajax.php?ano="+ano,
    type: 'get',
    dataType: 'JSON',
  ...
  $.ajax({
    url: "ajax/get_pontualidade_ano_ajax.php?ano="+(ano-1),
    type: 'get',
    dataType: 'JSON',    
  ...
  $.ajax({
    url: "ajax/get_pontualidade_ano_ajax.php?ano="+(ano-2),
    type: 'get',
    dataType: 'JSON',    
