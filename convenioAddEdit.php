...
if(!empty($_GET['id'])){
  ...
  $userData = $db->getRows('convenios', $conditions);
}
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Adicionar/Editar Convênio</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"><a href="convenioIndex.php" class="float-right"><i class="fad fa-backward"></i> Voltar</a></div>
        <div class="panel-body">
          <form method="post" action="convenioAction.php" class="form">
            ...
            <div class="form-group">
              <label>Logo</label>
              <input type="text" class="form-control" name="logo" value="<?php echo !empty($userData['logo'])?$userData['logo']:''; ?>">
            </div>
            <div class="form-group">
              <label>ANS</label>
              <input type="text" class="form-control" name="ans" value="<?php echo !empty($userData['ans'])?$userData['ans']:''; ?>">
            </div>
