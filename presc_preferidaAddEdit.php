...
if(!empty($_GET['id'])){
  ...
  $userData = $db->getRows('presc_preferidas', $conditions);
}
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"><a href="presc_preferidaIndex.php" class="float-right"><i class="fad fa-backward"></i> Voltar</a></div>
        <div class="panel-body">
          <form method="post" action="presc_preferidaAction.php" class="form">
            ...
            <div class="form-group">
              <label>Atalho</label>
              <input type="text" class="form-control" name="titulo" value="<?php echo !empty($userData['titulo'])?$userData['titulo']:''; ?>">
            </div>
            <div class="form-group">
              <label>Descrição</label>
              <textarea class="textarea" name="descricao"><?php echo !empty($userData['descricao'])?$userData['descricao']:''; ?></textarea>
            </div>
