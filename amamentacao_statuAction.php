...
$tblName = 'amamentacao_status';

// Set default redirect url
$redirectURL = 'amamentacao_statuIndex.php';
	...
	// If the data is not empty
			if(!empty($id)){
				...
				if($update){
					...
					// Set redirect url
					$redirectURL = 'amamentacao_statuAddEdit.php'.$idStr;
				}
			}else{
				// Insert data
				...
				if($insert){
					...
					// Set redirect url
					$redirectURL = 'amamentacao_statuAddEdit.php';
				}
			}
