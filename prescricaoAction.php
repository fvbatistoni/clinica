...
$redirectURL = 'prescricaoIndex.php';

if(isset($_POST['userSubmit'])){
	// Get submitted data
	$nome 	= strtoupper(addslashes($_POST['nome']));
	$rec_especial 	= $_POST['rec_especial'];
	...
	// If the data is not empty
			if(!empty($id)){
				...
				if($update){
					...
					// Set redirect url
					$redirectURL = 'prescricaoAddEdit.php'.$idStr;
				}
			}else{
				// Insert data
				...
				if($insert){
					...
					// Set redirect url
					$redirectURL = 'prescricaoAddEdit.php';
				}
			}
