...
if(!empty($_GET['id'])){
  ...
  $userData = $db->getRows('black_sub2', $conditions);
}
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"><a href="black_s2Index.php" class="float-right"><i class="fad fa-backward"></i> Voltar</a></div>
        <div class="panel-body">
          <form method="post" action="black_s2Action.php" class="form">
